...
// 1️⃣ forEach(callback (value, index, array) { })
// 배열을 빙글 빙글 돌면서 원하는것(콜백할수)을 할때
...
// 2️⃣ findIndex(callback (value) { 조건 } )
...
// ⚠️ sort()는 문자열 형태로 정렬하기 때문에 숫자는 제대로 정렬이 안될 수 있음.
