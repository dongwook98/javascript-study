...
// 4️⃣ Array.from() static 함수 사용
// Array.from()은 기존 배열로 부터 새로운 배열을 만들 수 있다.
// 매개변수에 순회가 가능한(iterable) 것을 전달해야함
array = Array.from('text'); // 문자열은 iterable
console.log(array);
array = Array.from(anotherArray); // 배열은 iterable
console.log(array);
