...
console.log(new Date()); // 현재 년 월 일 시간
...
console.log(now.toTimeString()); // 00:10:25 GMT+0900 (대한민국 표준시)
console.log(now.toISOString()); // ISO 8601 형식
console.log(now.toLocaleString('en-US')); // 11/15/2023, 12:08:07 AM
console.log(now.toLocaleString('ko-kr')); // 2023. 11. 15. 오전 12:08:07
